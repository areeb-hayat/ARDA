// scripts/addSuperUser.js
// Run this with: node scripts/addSuperUser.js
...
async function addSuperUser() {
  try {
    ...
    // Define the FormData model inline to avoid import issues
    const FormDataSchema = new mongoose.Schema({
      ...
      employmentHistory: [mongoose.Schema.Types.Mixed],
      relatives: [mongoose.Schema.Types.Mixed],
      parents: mongoose.Schema.Types.Mixed,
      dependants: mongoose.Schema.Types.Mixed,
    ...
    if (existingUser) {
      ...
      console.log('\n❓ Do you want to update? If yes, delete the user first and re-run this script.');
    } else {
      // Add the new user
      ...
      console.log('Username: super.user');
