// app/components/ProjectManagement/depthead/ProjectDetailsModal.tsx
'use client';
...
export default function ProjectDetailsModal({
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'deliverables' | 'members' | 'chat'>('overview');
  ...
  const pendingDeliverables = project.deliverables?.filter((d: any) => d.status !== 'done') || [];
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className={`text-sm ${colors.textMuted}`}>{project.title}</p>
                </div>
              </div>
              <button
                onClick={onClose}
